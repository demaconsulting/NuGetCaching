...
- **Pipeline evidence**: `lint.ps1` runs `dotnet sysml2tools lint 'docs/sysml2/**/*.sysml'` against
  the actual NuGetCaching model and fails the build on any syntax or reference error. The build-docs
...
**Requirement coverage**: `Caching-OTS-SysML2Tools-Lint`.
...
**Requirement coverage**: `Caching-OTS-SysML2Tools-Render`.

### Requirements Coverage

- **`Caching-OTS-SysML2Tools-Lint`**: SysML2Tools_LintSelfTest
- **`Caching-OTS-SysML2Tools-Render`**: SysML2Tools_RenderSvgSelfTest
